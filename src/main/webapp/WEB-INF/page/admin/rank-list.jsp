...
<html>
  ...
  <head>
    ...
    <link rel="stylesheet" href="/ssm_esms_oa/static/css/font.css">
    <link rel="stylesheet" href="/ssm_esms_oa/static/css/xadmin.css">
    <script type="text/javascript" src="/ssm_esms_oa/static/js/jquery-3.3.1.js"></script>
    <script type="text/javascript" src="/ssm_esms_oa/static/lib/layui/layui.js"></script>
    <script type="text/javascript" src="/ssm_esms_oa/static/js/xadmin.js"></script>
    <!-- 让IE8/9支持媒体查询，从而兼容栅格 -->
    <!--[if lt IE 9]>
    ...
    <![endif]-->
    <!-- Bootstrap -->
    <link href="/ssm_esms_oa/static/css/bootstrap.css" rel="stylesheet">
    <script type="text/javascript" src="/ssm_esms_oa/static/js/bootstrap.js"></script>
